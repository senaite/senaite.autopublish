# Contributing to senaite.autopublish

Third-party contributions are essential for keeping `senaite.autopublish` continuously 
improving. We simply cannot access the huge number of platforms and myriad 
configurations for running `senaite.autopublish`. We want to keep it as easy as 
...
The following is a set of guidelines for contributing to `senaite.autopublish`, which is 
...
bugs](https://github.com/senaite/senaite.autopublish/issues)? Do you have a
suggestion for improvement? Then by all means please [submit a new
issue](https://github.com/senaite/senaite.autopublish/issues/new), and do not
hesitate to comment on existing [open
issues](https://github.com/senaite/senaite.autopublish/issues).
...
platform (Operating System and version, how did you installed senaite.autopublish
...
The list of [open issues](https://github.com/senaite/senaite.autopublish/issues)
...
### Preliminaries
   ...
   2. [Fork senaite.autopublish from GitHub](
   https://github.com/senaite/senaite.autopublish/fork). This will copy the whole
   `senaite.autopublish` repository to your personal account.
   ...
   the actual username of your GitHub account):
          ...
          $ git clone https://github.com/YOUR_USERNAME/senaite.autopublish

   4. Your forked repository https://github.com/YOUR_USERNAME/senaite.autopublish will 
   receive the default name of `origin`. You can also add the original 
   `senaite.autopublish` repository, which is usually called `upstream`:

          $ cd senaite.autopublish
          $ git remote add upstream https://github.com/senaite/senaite.autopublish.git
...
```
$ git remote -v
origin    https://github.com/YOUR_USERNAME/senaite.autopublish.git (fetch)
origin    https://github.com/YOUR_USERNAME/senaite.autopublish.git (push)
upstream  https://github.com/senaite/senaite.autopublish.git (fetch)
upstream  https://github.com/senaite/senaite.autopublish.git (push)
```
...
Alternatively, you can merge `senaite.autopublish`'s `master` into your branch:
...
request](https://github.com/senaite/senaite.autopublish/compare/). Head to your
 ...
 * Add a changelog entry in [CHANGES.rst](https://github.com/senaite/senaite.autopublish/CHANGES.rst)
